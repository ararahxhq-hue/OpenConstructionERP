...
const SCENES: Record<string, Scene> = {
  ...
  ListChecks: () => (
    <>
      ...
      <Badge cx={39} cy={27} r={5} fill={C.green} glyph="check" shadow={false} />
      <RowBar x={49} y={25} w={34} h={4} fill={C.grey2} />
      <Badge cx={39} cy={43} r={5} fill={C.green} glyph="check" shadow={false} />
      <RowBar x={49} y={41} w={30} h={4} fill={C.grey2} />
      <rect x={34} y={54} width={10} height={10} rx={2.5} fill={C.white} stroke={C.grey1} strokeWidth={1.6} />
  ...
  CalendarClock: (accent) => (
    <>
      ...
      <rect x={31} y={12} width={4.5} height={8} rx={2} fill={C.blueDeep} stroke="none" />
      <rect x={59} y={12} width={4.5} height={8} rx={2} fill={C.blueDeep} stroke="none" />
      ...
      <circle cx={83.5} cy={59} r={13} fill={C.shadow} opacity={0.08} stroke="none" />
      <circle cx={82} cy={57} r={13} fill={C.white} stroke={C.blue} strokeWidth={2.4} />
      <path d="M82 49 v8 l5 3" stroke={C.blue} strokeWidth={2.2} fill="none" strokeLinecap="round" />
    </>
  ),
  ...
  ClipboardCheck: () => (
    <>
      ...
      <rect x={50} y={11} width={20} height={9} rx={3} fill={C.grey1} stroke="none" />
  ...
  Layers: (accent) => (
    <>
      <path d="M60 51 L86 60 L60 69 L34 60 Z" fill={C.shadow} opacity={0.08} stroke="none" />
      <path d="M60 49 L86 58 L60 67 L34 58 Z" fill={C.grey2} stroke={C.white} strokeWidth={1} />
      <path d="M60 35 L86 44 L60 53 L34 44 Z" fill={C.blue} stroke={C.white} strokeWidth={1} />
      <path d="M60 21 L86 30 L60 39 L34 30 Z" fill={C.blueLight} stroke={accent} strokeWidth={1.6} />
    </>
  ),
  ...
  Scale: (accent) => (
    <>
      ...
      <path d="M34 26 H86" stroke={C.blue} strokeWidth={2.6} fill="none" strokeLinecap="round" />
      <path d="M34 26 V31 M86 26 V31" stroke={C.grey1} strokeWidth={1.4} fill="none" />
      ...
      <path d="M48 60 H72 M60 58 V60" stroke={C.blueDeep} strokeWidth={3} fill="none" strokeLinecap="round" />
    </>
  ),
  ...
  FileSignature: () => (
    <>
      ...
      <g transform="rotate(40 72 54)">
        <rect x={69} y={40} width={6} height={20} rx={2} fill={C.ochre} stroke="none" />
        <path d="M69 60 L72 66 L75 60 Z" fill={C.blueDeep} stroke="none" />
        <rect x={69} y={39} width={6} height={4} rx={1} fill={C.blueDeep} stroke="none" />
      </g>
    </>
  ),
  ...
  Send: (accent) => (
    <>
      <rect x={16} y={30} width={40} height={28} rx={3} fill={C.white} stroke={C.grey1} strokeWidth={1.6} />
      <path d="M18 31 h36 l-18 13 z" fill={C.blueLight} stroke="none" />
      <path d="M16 32 l20 15 l20 -15" fill="none" stroke={C.blue} strokeWidth={1.6} />
      <path
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <circle cx={98} cy={52} r={11} fill={C.white} stroke={C.blue} strokeWidth={2.2} />
      <path d="M98 45 v7 l5 3" stroke={C.blue} strokeWidth={2} fill="none" strokeLinecap="round" />
    </>
  ),
  ...
  Table2: (accent) => (
    <>
      ...
      <path d="M48 27 V68 M72 27 V68" stroke={C.grey3} strokeWidth={1.2} fill="none" />
      <path d="M24 40 H96 M24 54 H96" stroke={C.grey3} strokeWidth={1.2} fill="none" />
  ...
  FolderOpen: (accent) => (
    <>
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M20 48 h18 l5 -6 h30 a3 3 0 0 1 3 3 v6 H20 z" fill={C.ochre} stroke="none" />
      <path
  ...
  Users: () => (
    <>
      ...
      <path d="M28 62 c0 -10 5 -16 12 -16 s12 6 12 16 z" fill={C.grey2} stroke="none" />
      <circle cx={80} cy={34} r={9} fill={C.grey2} stroke="none" />
      <path d="M68 62 c0 -10 5 -16 12 -16 s12 6 12 16 z" fill={C.grey2} stroke="none" />
      <circle cx={60} cy={30} r={10.5} fill={C.blue} stroke={C.white} strokeWidth={1} />
      <path
  ...
  Banknote: () => (
    <>
      <rect x={18} y={26} width={58} height={32} rx={4} fill={C.green} stroke="none" />
      <rect x={22} y={30} width={50} height={24} rx={2.5} fill="none" stroke={C.white} strokeWidth={1.2} opacity={0.7} />
      <circle cx={47} cy={42} r={8} fill="none" stroke={C.white} strokeWidth={1.6} opacity={0.85} />
      <circle cx={85} cy={53} r={13} fill={C.shadow} opacity={0.08} stroke="none" />
      <circle cx={84} cy={52} r={13} fill={C.ochre} stroke={C.white} strokeWidth={1.2} />
      <circle cx={84} cy={52} r={9} fill="none" stroke={C.white} strokeWidth={1.4} opacity={0.7} />
  ...
  ShieldAlert: () => (
    <>
      ...
      <path d="M60 28 V45" stroke={C.white} strokeWidth={4} strokeLinecap="round" fill="none" />
  ...
  LineChart: (accent) => (
    <>
      ...
      <path d="M34 52 L46 44 L58 48 L70 34 L82 28 L82 60 L34 60 Z" fill={C.blueLight} opacity={0.22} stroke="none" />
      <path
  ...
  Combine: () => (
    <>
      ...
      <path d="M50 27 C62 30 64 38 72 42" fill="none" stroke={C.blue} strokeWidth={2} strokeLinecap="round" />
      <path d="M50 59 C62 56 64 48 72 44" fill="none" stroke={C.grey1} strokeWidth={2} strokeLinecap="round" />
      <path
        d="M69 38 l6 5 l-6 4"
        fill="none"
        stroke={C.blue}
  ...
  Calculator: (accent) => (
    <>
      <rect x={40} y={10} width={40} height={64} rx={6} fill={C.blue} stroke="none" />
      <rect x={46} y={16} width={28} height={12} rx={2} fill={C.blueDeep} stroke="none" />
      <RowBar x={49} y={20} w={16} h={3.5} fill={C.blueLight} />
      <rect x={46} y={35} width={8} height={8} rx={1.6} fill={C.white} opacity={0.85} stroke="none" />
      <rect x={57} y={35} width={8} height={8} rx={1.6} fill={C.white} opacity={0.85} stroke="none" />
      <rect x={68} y={35} width={8} height={8} rx={1.6} fill={C.white} opacity={0.85} stroke="none" />
      <rect x={46} y={47} width={8} height={8} rx={1.6} fill={C.white} opacity={0.85} stroke="none" />
      <rect x={57} y={47} width={8} height={8} rx={1.6} fill={C.white} opacity={0.85} stroke="none" />
      <rect x={68} y={47} width={8} height={8} rx={1.6} fill={C.white} opacity={0.85} stroke="none" />
      <rect x={46} y={59} width={8} height={8} rx={1.6} fill={C.white} opacity={0.85} stroke="none" />
      <rect x={57} y={59} width={8} height={8} rx={1.6} fill={C.white} opacity={0.85} stroke="none" />
      <rect x={68} y={59} width={8} height={8} rx={1.6} fill={accent} stroke="none" />
    </>
  ),
  ...
  TrendingUp: (accent) => (
    <>
      ...
      <path d="M34 54 L50 42 L62 48 L84 26 L84 62 L34 62 Z" fill={C.green} opacity={0.16} stroke="none" />
      <path
  ...
  Ruler: (accent) => (
    <>
      <rect x={18} y={30} width={84} height={16} rx={2.5} fill={C.ochre} stroke="none" />
      <rect x={18} y={30} width={84} height={16} rx={2.5} fill="none" stroke={C.white} strokeWidth={1} opacity={0.5} />
      <path
        ...
        fill="none"
      />
      <path d="M18 58 H102 M18 54 V62 M102 54 V62" stroke={accent} strokeWidth={2} fill="none" />
      <path
  ...
  PackageCheck: () => (
    <>
      <Cube cx={50} ty={20} w={18} hh={9} depth={20} top={C.grey3} left={C.grey2} right={C.grey1} />
      <path d="M50 38 V58" stroke={C.ochre} strokeWidth={1.8} fill="none" opacity={0.85} />
  ...
  HardHat: (accent) => (
    <>
      ...
      <path d="M48 50 V32 M60 50 V29 M72 50 V32" stroke={C.white} strokeWidth={2} opacity={0.7} fill="none" />
      <rect x={54} y={42} width={12} height={8} rx={1.5} fill={accent} stroke="none" />
      <path d="M20 50 h80 a3 3 0 0 1 0 6 H20 a3 3 0 0 1 0 -6 z" fill={C.amber} stroke="none" />
    </>
  ),
  ...
  FileText: (accent) => (
    <>
      ...
      <path
        ...
        strokeWidth={1.6}
      />
      <path d="M62 8 l16 16 h-16 z" fill={C.panel} stroke={C.grey1} strokeWidth={1} />
  ...
  Crosshair: (accent) => (
    <>
      ...
      <path d="M32 24 H72 M32 60 H88 M42 20 V64" stroke={C.grey3} strokeWidth={1.2} fill="none" />
      <circle cx={66} cy={44} r={18} fill="none" stroke={accent} strokeWidth={2.2} />
      <circle cx={66} cy={44} r={9} fill="none" stroke={C.blue} strokeWidth={2} />
      <path
  ...
  Clock: (accent) => (
    <>
      <circle cx={62} cy={44} r={26} fill={C.shadow} opacity={0.08} stroke="none" />
      <circle cx={60} cy={42} r={26} fill={C.white} stroke={C.blue} strokeWidth={2.6} />
      <path d="M60 20 v4 M60 60 v4 M38 42 h4 M78 42 h4" stroke={C.grey1} strokeWidth={2} fill="none" />
      <path d="M60 42 V26" stroke={C.blueDeep} strokeWidth={2.6} fill="none" strokeLinecap="round" />
      <path d="M60 42 l12 6" stroke={accent} strokeWidth={2.6} fill="none" strokeLinecap="round" />
  ...
  Building2: (accent) => (
    <>
      <rect x={30} y={16} width={34} height={56} rx={2} fill={C.blue} stroke="none" />
      <rect x={64} y={34} width={24} height={38} rx={2} fill={C.grey2} stroke="none" />
      <path
        ...
        fill="none"
      />
      <path d="M37 25 h6" stroke={accent} strokeWidth={3.4} strokeLinecap="round" fill="none" />
      <path
        ...
        opacity={0.8}
      />
      <path d="M24 72 H96" stroke={C.grey1} strokeWidth={1.6} fill="none" strokeLinecap="round" />
    </>
  ),
  ...
  GitCompareArrows: (accent) => (
    <>
      ...
      <path d="M22 27 h6" stroke={C.red} strokeWidth={2.2} strokeLinecap="round" fill="none" />
      <RowBar x={31} y={25.5} w={12} h={3.2} fill={C.pink} />
      <path d="M22 37 h6" stroke={C.red} strokeWidth={2.2} strokeLinecap="round" fill="none" />
      ...
      <path d="M78 27 h6 M81 24 v6" stroke={C.green} strokeWidth={2.2} strokeLinecap="round" fill="none" />
      <RowBar x={88} y={25.5} w={11} h={3.2} fill={C.green} opacity={0.3} />
      <path d="M78 37 h6 M81 34 v6" stroke={C.green} strokeWidth={2.2} strokeLinecap="round" fill="none" />
  ...
  NotebookPen: (accent) => (
    <>
      ...
      <g transform="rotate(38 70 52)">
        <rect x={67} y={38} width={6} height={20} rx={2} fill={C.ochre} stroke="none" />
        <path d="M67 58 L70 64 L73 58 Z" fill={C.blueDeep} stroke="none" />
        <rect x={67} y={37} width={6} height={4} rx={1} fill={C.blueDeep} stroke="none" />
      </g>
    </>
  ),
  ...
  Handshake: (accent) => (
    <>
      ...
      <rect x={46} y={45} width={28} height={16} rx={6} fill={C.grey3} stroke={C.grey1} strokeWidth={1.2} />
      <path d="M53 49 v8 M59 49 v8 M65 49 v8 M71 49 v8" stroke={accent} strokeWidth={1.4} fill="none" />
  ...
  Flag: (accent) => (
    <>
      <path d="M46 16 V70" stroke={C.blueDeep} strokeWidth={3} fill="none" strokeLinecap="round" />
      <path d="M46 18 h32 l-7 8 7 8 H46 z" fill={C.red} stroke="none" />
      <Star cx={56} cy={26} r={4} fill={accent} />
      <path d="M30 70 H74" stroke={C.grey1} strokeWidth={2.2} fill="none" strokeLinecap="round" />
    </>
  ),
  ...
  FileSpreadsheet: (accent) => (
    <>
      ...
      <path d="M26 34 H94 M26 46 H94 M26 58 H94" stroke={C.grey3} strokeWidth={1.2} fill="none" />
      <path d="M48 22 V72 M72 22 V72" stroke={C.grey3} strokeWidth={1.2} fill="none" />
      ...
      <rect x={74} y={35} width={18} height={10} fill={C.green} opacity={0.22} stroke="none" />
  ...
  FileCheck: () => (
    <>
      ...
      <Badge cx={49} cy={29} r={3.6} fill={C.amber} glyph="warn" glyphFill={C.white} shadow={false} />
  ...
  BadgeCheck: (accent) => (
    <>
      ...
      <circle cx={60} cy={38} r={22} fill="none" stroke={C.blueLight} strokeWidth={2} strokeDasharray="2 3" />
  ...
  Gavel: (accent) => (
    <>
      <rect x={30} y={62} width={38} height={7} rx={2} fill={C.blueDeep} stroke="none" />
      <g transform="rotate(-38 66 40)">
        <rect x={56} y={30} width={22} height={16} rx={3} fill={C.blue} stroke="none" />
        <rect x={53} y={31} width={4} height={14} rx={1.5} fill={C.blueDeep} stroke="none" />
        <rect x={77} y={31} width={4} height={14} rx={1.5} fill={C.blueDeep} stroke="none" />
        <rect x={65} y={44} width={5} height={30} rx={2.5} fill={C.ochre} stroke="none" />
      </g>
      <path
  ...
  FileStack: () => (
    <>
      <rect x={30} y={16} width={46} height={50} rx={4} fill={C.white} stroke={C.grey1} strokeWidth={1.4} />
      <rect x={36} y={20} width={46} height={50} rx={4} fill={C.white} stroke={C.grey1} strokeWidth={1.4} />
  ...
  Dice5: (accent) => (
    <>
      <rect x={32} y={29} width={38} height={38} rx={7} fill={C.shadow} opacity={0.08} stroke="none" />
      <rect x={30} y={26} width={38} height={38} rx={7} fill={C.white} stroke={C.grey1} strokeWidth={1.8} />
      ...
      <path d="M74 60 q8 -34 16 0" fill={C.blueLight} opacity={0.25} stroke="none" />
      <path d="M74 60 q8 -34 16 0" fill="none" stroke={C.blue} strokeWidth={1.8} />
  ...
  Trophy: (accent) => (
    <>
      <path d="M44 20 h-8 a6 6 0 0 0 0 12 h5" fill="none" stroke={C.ochre} strokeWidth={3} />
      <path d="M76 20 h8 a6 6 0 0 1 0 12 h-5" fill="none" stroke={C.ochre} strokeWidth={3} />
      <path d="M44 18 h32 v10 a16 16 0 0 1 -32 0 z" fill={C.ochre} stroke="none" />
      <path d="M60 44 V54" stroke={C.ochre} strokeWidth={4} fill="none" />
      <path d="M48 60 h24 l-3 -6 H51 z" fill={C.amber} stroke="none" />
      <rect x={44} y={60} width={32} height={5} rx={2} fill={C.blueDeep} stroke="none" />
  ...
  MapPin: (accent) => (
    <>
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <ellipse cx={66} cy={54} rx={7} ry={2.4} fill={C.shadow} opacity={0.12} stroke="none" />
  ...
  Camera: (accent) => (
    <>
      ...
      <circle cx={60} cy={48} r={4} fill={C.white} stroke="none" opacity={0.85} />
      <rect x={78} y={34} width={8} height={4} rx={1.5} fill={accent} stroke="none" />
    </>
  ),
};
